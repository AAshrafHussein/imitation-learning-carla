...
class PsudoAutoController(Controller):
    ...
    def control(self, pts_2D, measurements, depth_array):
        ...
        curr_speed = measurements.player_measurements.forward_speed 
        self.steer = measurements.player_measurements.autopilot_control.steer
        self.throttle = measurements.player_measurements.autopilot_control.throttle
